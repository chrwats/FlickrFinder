...
let API_KEY = "5df7f572a130bba25ae824d8ed1878de"
let EXTRAS = "url_m"
let SAFE_SEARCH = "1"
...
class ViewController: UIViewController {
    ...
    @IBAction func searchPhotosByPhraseButtonTouchUp(sender: AnyObject) {
        ...
        if !self.phraseTextField.text.isEmpty {
            ...
            photoTitleLabel.textColor = UIColor.redColor()
        ...
        if !self.latitudeTextField.text.isEmpty && !self.longitudeTextField.text.isEmpty {
            if validLatitude() && validLongitude() {
                ...
                if !validLatitude() && !validLongitude() {
                    ...
                    photoTitleLabel.textColor = UIColor.redColor()
                    self.photoTitleLabel.text = "Latitude Invalid.\nLat should be [-90, 90]."
                } else {
                    photoTitleLabel.textColor = UIColor.redColor()
                    self.photoTitleLabel.text = "Longitude Invalid.\nLon should be [-180, 180]."
                }
            }
        } else {
            if self.latitudeTextField.text.isEmpty && self.longitudeTextField.text.isEmpty {
                ...
                self.photoTitleLabel.text = "Latitude Empty."
            } else {
                self.photoTitleLabel.text = "Longitude Empty."
            }
        }
    }
